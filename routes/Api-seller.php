...
Route::middleware(['jwt','Only_sellers'])->group(function () {
    ...
    Route::any('/trader/get/product/{id_category}',[TradersController::class,'get_products_by_category']);
    ...
    Route::any('/trader/get/my/orders',[Seller_ordersController::class,'get_traders_orders']);
    Route::any('/trader/delete/offer/code/{id_offer}',[TradersController::class,'delete_offer_code']);
